...
class Calendar extends Component {
  ...
  loadPeople(nextProps) {
    ...
    if (this.state.isTouch) {
      ...
      this.setState({peopleSelect: [{label: 'No. of people', value: '', disabled: true}, ...peopleSelect]});
      ...
      <form onSubmit={handleSubmit}>
        ...
        {this.state.isTouch
         ...
         <Field name="people" component='select' onChange={handlePeopleChange}>
           ...
           {this.props.maxPartySize && maxPartySizeModal &&
           <option value='maxPartySizeModal'>{this.props.maxPartySize + 1}+</option>
           }
         </Field>
          :
         <Field
        ...
        {this.state.isTouch
         ...
         <option disabled>Day/Evening</option>
